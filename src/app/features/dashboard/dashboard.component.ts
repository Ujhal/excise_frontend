import { Component, OnInit, OnDestroy, ViewChild, ChangeDetectorRef, ElementRef, AfterViewInit, NgZone, inject } from '@angular/core';
...
export class DashboardComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  private canvasAnimationId?: number | null;
  ...
  private initBubbleEngine(): void {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      this.bubbles = [];
      const totalBubbles = 30; // Optimized count for smooth 60fps
  ...
  private loadDashboardStatsLight(forceRefresh = false) {
    ...
    if (forceRefresh || !this.dashboardCounts) {
